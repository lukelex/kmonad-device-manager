...
// manager-owned configuration. Behavior must not contain a KMonad defcfg,
// input target, or output target: the manager resolves DeviceID and renders
// the complete platform-owned configuration header itself.
